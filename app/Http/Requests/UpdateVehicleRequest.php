...
class UpdateVehicleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'license_plate' => 'required|string|max:15|unique:vehicles,license_plate,' . $this->route('vehicle')->id,
    ...
    public function messages(): array
    {
        return [
            ...
            'license_plate.unique' => 'Nomor plat sudah terdaftar pada kendaraan lain.',
